...
#include "SLCutterIndividual.generated.h"
...
class USEMLOG_API USLCutterIndividual : public USLBaseIndividual
{
    GENERATED_BODY()
...
public:
    ...
    virtual FString GetTypeName() const override { return FString("CutterIndividual"); };
