...
#include "SLCuttieIndividual.generated.h"
...
class USEMLOG_API USLCuttieIndividual : public USLBaseIndividual
{
    GENERATED_BODY()
...
public:
    ...
    virtual FString GetTypeName() const override { return FString("CuttieIndividual"); };
